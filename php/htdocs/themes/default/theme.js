...
function URC_Theme_dragControlValue(sCtlCls,initVal,dragFulX,dragFulY,currVal,dragRelX,dragRelY)
{
  ...
  case 'rb-l':
    newVal=currVal-(dragRelX*Math.cos(pi*(0.165+1.67*currVal))+dragRelY*Math.sin(pi*(0.165+1.67*currVal)))/(30*pi);
    break;

  case 'rb-xl':
    newVal=currVal-(dragRelX*Math.cos(pi*(0.165+1.67*currVal))+dragRelY*Math.sin(pi*(0.165+1.67*currVal)))/(38*pi);
    break;
  ...
  case 'hs-l':
  case 'hb-l':
    newVal=initVal+dragFulX/200;
    break;

  case 'hs-xl':
  case 'hb-xl':
    newVal=initVal+dragFulX/400;
    break;
  ...
  case 'vs-l':
  case 'vb-l':
    newVal=initVal-dragFulY/200;
    break;

  case 'vs-xl':
  case 'vb-xl':
    newVal=initVal-dragFulY/400;
    break;
  }
  return newVal;
}
...
function URC_Theme_setControlValue(sCtlCls,sCtlId,mCtlVal)
{
  ...
  case 'rb-l':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    ctlElmt=document.getElementById('URC-'+sCtlId+'-ctl');
    ctlElmt.style.left=parseInt(Math.round(25-17*Math.sin(pi*(0.165+1.67*mCtlVal))))+'px';
    ctlElmt.style.top=parseInt(Math.round(25+17*Math.cos(pi*(0.165+1.67*mCtlVal))))+'px';
    break;

  case 'rb-xl':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    ctlElmt=document.getElementById('URC-'+sCtlId+'-ctl');
    ctlElmt.style.left=parseInt(Math.round(30-22*Math.sin(pi*(0.165+1.67*mCtlVal))))+'px';
    ctlElmt.style.top=parseInt(Math.round(30+22*Math.cos(pi*(0.165+1.67*mCtlVal))))+'px';
    break;
  ...
  case 'hb-l':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    mCtlPos=parseInt(200*mCtlVal);
    document.getElementById('URC-'+sCtlId+'-hgl').style.width=mCtlPos+'px';
    document.getElementById('URC-'+sCtlId+'-top-l').style.width=(10+mCtlPos)+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-r'); oCtlElmt.style.left=(10+mCtlPos)+'px'; oCtlElmt.style.width=(210-mCtlPos)+'px';
    document.getElementById('URC-'+sCtlId+'-ctl').style.left=(2+mCtlPos)+'px';
    break;

  case 'hs-xl':
  case 'hb-xl':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    mCtlPos=parseInt(400*mCtlVal);
    document.getElementById('URC-'+sCtlId+'-hgl').style.width=mCtlPos+'px';
    document.getElementById('URC-'+sCtlId+'-top-l').style.width=(10+mCtlPos)+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-r'); oCtlElmt.style.left=(10+mCtlPos)+'px'; oCtlElmt.style.width=(410-mCtlPos)+'px';
    document.getElementById('URC-'+sCtlId+'-ctl').style.left=(2+mCtlPos)+'px';
    break;
  ...
  case 'vb-l':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    mCtlPos=parseInt(200*mCtlVal);
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-hgl'); oCtlElmt.style.top=(210-mCtlPos)+'px'; oCtlElmt.style.height=mCtlPos+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-u').style.height=(210-mCtlPos)+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-d'); oCtlElmt.style.top=(210-mCtlPos)+'px'; oCtlElmt.style.height=(10+mCtlPos)+'px';
    document.getElementById('URC-'+sCtlId+'-ctl').style.top=(202-mCtlPos)+'px';
    break;
  ...
  case 'vb-xl':
    mCtlVal=parseFloat(mCtlVal); if( mCtlVal<0 ) mCtlVal=0; else if( mCtlVal>1 ) mCtlVal=1;
    mCtlPos=parseInt(400*mCtlVal);
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-hgl'); oCtlElmt.style.top=(410-mCtlPos)+'px'; oCtlElmt.style.height=mCtlPos+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-u').style.height=(410-mCtlPos)+'px';
    oCtlElmt=document.getElementById('URC-'+sCtlId+'-top-d'); oCtlElmt.style.top=(410-mCtlPos)+'px'; oCtlElmt.style.height=(10+mCtlPos)+'px';
    document.getElementById('URC-'+sCtlId+'-ctl').style.top=(402-mCtlPos)+'px';
    break;
